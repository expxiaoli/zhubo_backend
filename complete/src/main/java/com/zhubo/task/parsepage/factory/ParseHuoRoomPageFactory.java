...
public class ParseHuoRoomPageFactory extends BaseParsePageFactory {
    @Override
    public BaseParsePageTask create(String filePath, ResourceManager resourceManager) {
        return new ParseAppRoomPageWithTopAudienceIdentifyTask(filePath, invalidAliasIds, resourceManager, 14);
    }
