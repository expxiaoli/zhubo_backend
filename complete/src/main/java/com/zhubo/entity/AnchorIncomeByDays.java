...
@Entity
@Table(name = "AnchorIncomeByDays_1003")
public class AnchorIncomeByDays {
    @Id
    @GeneratedValue
    @Column(name = "id")
    private Long id;
    ...
    public AnchorIncomeByDays() {
        
    }
    
    public AnchorIncomeByDays(Long anchorId, Integer platformId, Integer money, Date recordEffectiveTime) {
